...
export function ProjectCard({ project }: Props) {
  ...
  return (
    <motion.article
      className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-border bg-card/80 p-5 shadow-soft backdrop-blur-md"
    ...
    >
      ...
      <div className="mt-auto flex items-center gap-2 pt-4 text-sm font-semibold">
